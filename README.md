...
A live demo of the project is available at [https://bokeptoket.pages.dev](https://bokeptoket.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep toket`)
...
1. Fork the [repository](https://github.com/saungkujon/bokeptoket/fork) on GitHub.
