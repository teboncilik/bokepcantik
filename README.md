...
A live demo of the project is available at [https://bokepsemi.pages.dev](https://bokepsemi.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep semi`)
...
1. Fork the [repository](https://github.com/kerinkerj/bokepsemi/fork) on GitHub.
